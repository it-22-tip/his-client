...
export default function (PDFJS) {
  ...
  function PDFJSWrapper (canvasParent, annotationLayerElt, emitEvent) {
            ...
            allPages.push(
              pdfDoc.getPage(pageNumber)
                .then(function (page) {
                  ...
                  let printCanvasElt = win.document.body.appendChild(win.document.createElement('canvas'))
    ...
    this.renderPage = function (rotate) {
      ...
      let scale = canvasElt.offsetWidth / pdfPage.getViewport(1).width * (window.devicePixelRatio || 1)
    ...
    this.forEachPage = function (pageCallback) {
      let numPages = pdfDoc.pdfInfo.numPages(
