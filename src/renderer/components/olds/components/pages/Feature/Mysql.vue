  ...
  <app-wrapper>
    <page-container>
      ...
      <div slot="default" class="padding-20">
        ...
        <md-snackbar :md-position="`center`" :md-duration="Infinity" :md-active.sync="connectionSuccessMessage" md-persistent>
          <span>{{ snackbar }}</span>
        </md-snackbar>
      </div>
