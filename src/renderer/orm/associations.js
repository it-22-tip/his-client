const associations = function (models) {
  ...
  const { Persons, Regencies, Almamaters, Villages, Provinces, Districts, Employees, JobTitles, Licenses, LicenseTypes, AddressHistories } = models
  // ok
  ...
  Persons.belongsTo(Regencies, {foreignKey: 'BirthPlaceRegencyCode', targetKey: 'Code', as: 'BirthPlaceRegency'}) // ok
