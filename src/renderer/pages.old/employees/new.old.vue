...
export default {
  components: {
    ...
    'address-form': () => import('@components/form/address-form'),
    'birthdateplace-form': () => import('@components/form/birthdateplace-form'),
    'jobtitle-picker': () => import('@components/picker/jobtitle-picker'),
    'gender-picker': () => import('@components/picker/gender-picker'),
    'bloodtype-picker': () => import('@components/picker/bloodtype-picker'),
    'mstepper': () => import('@components/form/mstepper'),
    'mstep': () => import('@components/form/mstep'),
    'education-form': () => import('@components/form/education-form'),
    'stepper-education': () => import('@components/stepper/stepper-education'),
    'stepper-fin': () => import('@components/stepper/stepper-fin'),
    'stepper-personal': () => import('@components/stepper/stepper-personal')
  },
  mixins: [
    orm
  ],
